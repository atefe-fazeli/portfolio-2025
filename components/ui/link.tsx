...
const Link: React.FC<LinkProps> = ({
  ...
  // Base classes
  const baseClasses = 'transition-all duration-300 inline-flex items-center gap-2';
  ...
  const variantClasses = {
    ...
    button: 'px-4 py-2 rounded-lg font-medium border',
  ...
  const colorClasses = {
    primary: {
      ...
      icon: 'bg-blue-600 text-white hover:bg-blue-700',
    },
    secondary: {
